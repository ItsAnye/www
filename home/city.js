...
loader.load('https://prod.spline.design/VrUPbpHq-7jRMzpW/scene.splinecode', (splineScene) => {
...
// document.getElementsByTagName('canvas')[0].style.marginLeft = '25px';
// document.getElementsByTagName('canvas')[0].style.marginTop = '25px';